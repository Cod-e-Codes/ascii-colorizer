...
Releases are published when a version tag is pushed (for example `v0.1.6`). See [latest release](https://github.com/Cod-e-Codes/ascii-colorizer/releases/latest).

### Install with Cargo

```bash
cargo install --git https://github.com/Cod-e-Codes/ascii-colorizer.git --tag v0.1.6 --locked
```
